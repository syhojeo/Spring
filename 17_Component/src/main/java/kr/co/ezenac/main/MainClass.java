...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		TestBean4 xml300 = ctx1.getBean("xml300", TestBean4.class);
//		TestBean4 xml300 = ctx1.getBean(TestBean4.class);
		System.out.printf("xml300 : %s\n", xml300);
		...
		TestBean4 java5 = ctx2.getBean("xml300", TestBean4.class);
		...
		TestBean5 java500 = ctx2.getBean("java500", TestBean5.class);
